...
-- Volcando estructura para tabla supermercado.historico_precio
...
-- Volcando datos para la tabla supermercado.historico_precio: ~0 rows (aproximadamente)
DELETE FROM `historico_precio`;
/*!40000 ALTER TABLE `historico_precio` DISABLE KEYS */;
INSERT INTO `historico_precio` (`id`, `precio`, `fecha`, `id_producto`) VALUES
	(1, 20, '2020-01-09 13:38:47', 55),
	(2, 30, '2020-01-09 13:39:20', 55),
	(3, 35, '2020-01-09 13:40:37', 55);
...
INSERT INTO `producto` (`id`, `nombre`, `descripcion`, `imagen`, `precio`, `descuento`, `id_usuario`, `id_categoria`, `fecha_baja`, `fecha_alta`, `fecha_modificacion`) VALUES
	...
	(55, ' blueberry muffin', 'morcilla', 'https://image.flaticon.com/icons/png/512/372/372627.png', 40, 100, 1, 1, NULL, '2020-01-09 13:13:46', '2020-01-09 13:40:37');
...
-- Volcando estructura para disparador supermercado.tau_producto
DROP TRIGGER IF EXISTS `tau_producto`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `tau_producto` AFTER UPDATE ON `producto` FOR EACH ROW BEGIN

	INSERT INTO historico_precio 
	(precio, fecha, id_producto)
	VALUES 
	(OLD.precio, NOW(), OLD.id);
